            ...
            items: [
                {
                    ...
                    items: [
                        {label: 'Quản lí lịch trình', icon: 'pi pi-fw pi-server', to: '/uikit/lichtrinh'},
                        {label: 'Thêm tuyến đường', icon: 'pi pi-fw pi-plus-circle', to: '/uikit/tuyenduong'},
                        {label: 'Chi tiết tuyến đường', icon: 'pi pi-fw pi-car', to: '/uikit/tuyenduongchitiet'},
                        {label: 'Quản lí tàu', icon: 'pi pi-fw pi-database', to: '/uikit/tau'},
