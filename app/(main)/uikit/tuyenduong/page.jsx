...
const PortAutoComplete = ({ label, name, onPortSelected }) => {
                            ...
                            <Form className="formgrid grid">
                                <FieldArray name="waypoints">
                                    {({ remove, push }) => (
                                        <>
                                            <div className="p-col-12">
                                                <Button type="button" icon="pi pi-plus" label="Thêm điểm dừng" onClick={() => handleAddWaypoint(push)} />
                                            </div>
                                            {values.waypoints.map((waypoint, index) => (
                                                <div key={index} className="p-field p-col-12 md:col-4 flex flex-row flex-wrap">
                                                    <PortAutoComplete
                                                    ...
                                                    />
                                                    <Button type="button" icon="pi pi-times" className="p-button-danger flex " onClick={() => handleRemoveWaypoint(index, remove)} />
                                                </div>
                                            ))}
