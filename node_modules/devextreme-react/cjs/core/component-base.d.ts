...
declare abstract class ComponentBase<P extends IHtmlOptions> extends React.PureComponent<P> {
    ...
    static contextType: React.Context<UpdateLocker>;
    context: React.ContextType<typeof RemovalLockerContext> | undefined;
    ...
    private _createDXTemplates;
    private _clearInstantiationModels;
    private _updateTemplates;
    private _childNodes;
    private readonly _optionsManager;
    protected useRequestAnimationFrameFlag: boolean;
    protected useDeferUpdateForTemplates: boolean;
    protected guardsUpdateScheduled: boolean;
    constructor(props: P);
